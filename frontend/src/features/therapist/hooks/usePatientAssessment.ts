...
export const useGetPatientAssessmentStatus = (patientId: number | null) => {
  return useQuery({
    ...
    queryFn: () =>
      patientId ? TherapistService.getPatientAssessmentStatus(patientId) : null,
    enabled: !!patientId,
  });
};
...
export const useGetPatientDocuments = (patientId: number | null) => {
  return useQuery({
    ...
    queryFn: () =>
      patientId ? TherapistService.getPatientDocuments(patientId) : null,
    enabled: !!patientId,
...
export const useGetPatientMedicalHistory = (patientId: number | null) => {
  return useQuery({
    ...
    queryFn: () =>
      patientId ? TherapistService.getPatientMedicalHistory(patientId) : null,
    enabled: !!patientId,
  });
};
