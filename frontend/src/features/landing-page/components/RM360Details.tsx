    ...
    >
      <Container sx={{ mt: 10, mb: 10 }}>
        <Stack spacing={2} sx={{ mb: 6, textAlign: 'center' }}>
          <LandingPageTypography variant="h4" component="h2" marked="center">
            ...
            <Paper variant="outlined" sx={cardSx}>
              <Box sx={{ p: { xs: 2.5, sm: 3 } }}>
                ...
                >
                  ...
                  cognitive testing tool, combined with expert clinical guidance
                  to help identify potential underlying and secondary treatable
                  contributors to memory loss. The program is designed to
                  support overall health optimization and is integrated with an
            ...
            <Paper variant="outlined" sx={cardSx}>
              <Box sx={{ p: { xs: 2.5, sm: 3 } }}>
                ...
                <LandingPageTypography
                  ...
                  sx={{ mt: 1.5, color: 'text.secondary', lineHeight: 1.7 }}
                >
                  DMAC™ (Dynamic Mobile Assessment of Cognition) is an
                  AI-powered, self-administered online cognitive assessment
                  designed to evaluate multiple key cognitive domains, including
          ...
          <Grid item xs={12} md={6}>
            <Paper variant="outlined" sx={cardSx}>
              <Box sx={{ p: { xs: 2.5, sm: 3 } }}>
                ...
                >
                  Your results don’t stand alone. RM360™ includes expert
                  clinical guidance to help identify possible underlying or
                  secondary contributors to memory and cognitive concerns and to
                  guide appropriate next steps with your primary care physician,
                ...
                <LandingPageTypography
                  ...
                  sx={{ mt: 1.25, color: 'text.secondary', lineHeight: 1.7 }}
                >
                  This process is designed to support awareness and
                  optimization—not replace medical care.
                </LandingPageTypography>
              </Box>
            </Paper>
          </Grid>
            ...
            <Paper variant="outlined" sx={cardSx}>
              <Box sx={{ p: { xs: 2.5, sm: 3 } }}>
                <LandingPageTypography
                  ...
                  sx={{ fontWeight: 800 }}
                >
                  Personalized Brain Training with LICCA™
                </LandingPageTypography>
                <LandingPageTypography
                  variant="body2"
                  sx={{ mt: 1.5, color: 'text.secondary', lineHeight: 1.7 }}
                ...
                <Grid container spacing={4}>
                  <Grid item xs={12} md={6}>
                    <LandingPageTypography
                      ...
                      sx={{ fontWeight: 800 }}
                    >
                      Designed to Support Neuroplasticity
                    </LandingPageTypography>
                    <LandingPageTypography
                      variant="body2"
                      sx={{ mt: 1.5, color: 'text.secondary', lineHeight: 1.7 }}
                    >
                      ...
                      form new connections. RM360™ is designed to support this
                      process through:
                    </LandingPageTypography>
                    <Stack spacing={1.25} sx={{ mt: 2 }}>
                    ...
                    <LandingPageTypography
                      ...
                      sx={{ mt: 2, color: 'text.secondary', lineHeight: 1.7 }}
                    >
                      Consistency matters. Many users report improved confidence
                      and daily functioning with regular participation.
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <Stack spacing={1.25} sx={{ mt: 2 }}>
                      ...
                      <CheckLine>
                        Individuals with cognitive changes after illness or
                        injury
                      </CheckLine>
                      <CheckLine>
                      ...
                      <CheckLine>
                        Health-conscious adults wanting baseline cognitive
                        awareness
                      </CheckLine>
                    </Stack>
                  </Grid>
            ...
            <Paper variant="outlined" sx={cardSx}>
              <Box sx={{ p: { xs: 2.5, sm: 3 } }}>
                <LandingPageTypography
                  ...
                  sx={{ fontWeight: 800 }}
                >
                  Research & Medical Leadership
                </LandingPageTypography>
                <LandingPageTypography
                  variant="body2"
                  sx={{ mt: 1.5, color: 'text.secondary', lineHeight: 1.7 }}
                >
                  RM360™, DMAC™ 5.0 AI, and LICCA™ are researched and
                  developed using data from thousands of patients and healthy
                  control subjects by:
                </LandingPageTypography>
