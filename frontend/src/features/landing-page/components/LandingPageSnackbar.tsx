...
function Transition(props: TransitionProps & { children: React.ReactElement }) {
...
function LandingPageSnackbar(props: SnackbarProps & ExtraSnackbarProps) {
...
export default styled(LandingPageSnackbar)(styles);
