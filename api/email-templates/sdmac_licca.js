...
export function getSDMACLiccaEmailContent({ userName, link }) {
  return {
    ...
    html: `
      ...
      <ul>
        <li><b>Self Digital Mobile Assessment of Cognition (S-DMAC) 5.0 AI</b> — a comprehensive cognitive assessment evaluating 10 key cognitive domains</li>
      </ul>
      ...
      <ul>
        ...
        <li>This assessment is designed to provide an in-depth understanding of cognitive function using advanced, AI-integrated analysis.</li>
      </ul>
      <p><b>AND</b></p>
      ...
      <h4>Self Dynamic Mobile Assessment of Cognition (SDMAC) — Test Guidelines</h4>
      <ul>
      ...
      <p>We have integrated expert guidance to optimize your body to brian for connecting neurons in the brain.You may choose to upgrade before or after completing your cognitive assessment SDMAC.</p>

      <b>Expert Guidance</b>
      <ul>
        <li><b>Personalized Medical Information Review</b> An individualized collection of your medical history and common disease affecting diagnostic tools—including relevant laboratory and blood test information—is organized to help guide medical decision-making through our expert-guided process. This approach focuses on optimizing overall health to support brain function.</li>
        <li>Our expert guidance includes licensed physicians and/or trained clinicians who help identify cognitive concerns and guide you to seek appropriate evaluation and treatment with your primary care physician, neurologist, or geriatric specialist in your local area.</li>
      </ul>
