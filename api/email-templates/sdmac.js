// SDMAC Email Content Generator
export function getSDMACEmailContent({ userName, link }) {
  return {
    subject: 'Thank you for ordering S-DMAC 5.0 AI',
    html: `
      <p>Dear ${userName},</p>
      <h3>Thank you for ordering Self Dynamic Mobile Assessment of Cognition (S-DMAC) 5.0 AI — a comprehensive cognitive assessment evaluating 10 key cognitive domains.</h3>
      ...
      <b>Expert Guidance</b>
      <ul>
        <li>Personalized Medical Information Review: An individualized collection of your medical history and common disease affecting diagnostic tools—including relevant laboratory and blood test information—is organized to help guide medical decision-making through our expert-guided process. This approach focuses on optimizing overall health to support brain function.</li>
