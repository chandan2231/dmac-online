// RM360_PACK_6_SUPERVISED_TRAINING Email Content Generator
...
export function getRM360Pack6SupervisedTrainingEmailContent({ userName, link }) {
  return {
    subject: 'Thank you for ordering RM360 Pack- with 6 Sessions of Remote Assisted Cognitive Training',
    html: `
      <p>Dear ${userName},</p>
      <h3>Thank you, you made a smart decision to order RM360 Pack- with 6 Sessions of Remote Assisted Cognitive Training contents:</h3>
      <ul>
      ...
      <b>6 Remote assisted training session</b>
      <ul>
        <li>6 Remote assisted training session to guide you through online cognitive training, you or your family member have to follow through the calendar and make a schedule with a cognitive therapist available online. Most of the individuals after 6 sessions are able to navigate and continue the training by themself, some time family help is required.</li>
      </ul>
