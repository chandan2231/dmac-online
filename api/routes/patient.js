...
router.post('/upload-document',  authenticateUser, upload.single('file'), uploadDocument)
...
router.post('/book/consultation', authenticateUser, bookConsultationWithGoogleCalender)
router.post('/consultation-list', authenticateUser, getConsultationList)
router.post('/therapist-consultation-list', authenticateUser, getTherapistConsultationList)
router.post('/reschedule/consultation', authenticateUser, rescheduleConsultationWithGoogleCalendar)
router.post('/reschedule/therapist-consultation', authenticateUser, rescheduleTherapistConsultation)
router.post('/cancel/consultation', authenticateUser, cancelConsultationByConsultant)
router.post('/therapist-slot', authenticateUser, getAvailableTherapistSlots)
router.post('/book/therapist-consultation', authenticateUser, bookTherapistConsultation)
